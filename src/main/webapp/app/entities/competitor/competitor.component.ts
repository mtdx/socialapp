...
export class CompetitorComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Competitor) {
        return item.id;
    }
    registerChangeInCompetitors() {
        this.eventSubscriber = this.eventManager.subscribe('competitorListModification', (response) => this.reset());
    }
